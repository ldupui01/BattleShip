...
public interface Ship {
    ...
    * @throws IllegalArgumentException if the given position is not occupied by this ship, or is outside the array.
    * @return boolean true if the ship is hit(so, always pretty much)
    */
    boolean shootAt(int row, int column) throws IllegalArgumentException;
